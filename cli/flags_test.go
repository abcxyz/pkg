...
func TestFlagWithPositional(t *testing.T) {
	cases := []struct {
		...
		{
			name: "flag_before_positional", // passes
			args: []string{"--my-bool", "true", "my-positional-value"},
		},
		{
			name: "positional_before_flag", // fails
			args: []string{"my-positional-value", "--my-bool", "true"},
		},
	}
