...
func TestGRPCStreamingInterceptor(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			exp: "INFO\ttest\t{\"logging.googleapis.com/trace\": \"projects/my-project/traces/105445aa7843bc8bf206b12000100000\"}",
		},
	}
...
func testLogger(tb testing.TB) (*zap.SugaredLogger, *bytes.Buffer) {
	tb.Helper()
